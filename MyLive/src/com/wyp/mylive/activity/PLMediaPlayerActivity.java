...
import com.wyp.mylive.fragment.live.LiveRoomCleanFragment;
import com.wyp.mylive.fragment.live.LiveRoomFragment;
...
public class PLMediaPlayerActivity extends AppCompatActivity {
    ...
    private void setAdapter() {
    	...
    	fragments.add(new LiveRoomFragment());
    	fragments.add(new LiveRoomCleanFragment());
	...
	private void setViews() {
    	viewPager = (ViewPager) findViewById(R.id.vp_room);
