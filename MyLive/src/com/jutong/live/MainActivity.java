...
/**
 * 这个包主要是推流给服务器      其中用到了NDK 开发 包名一定要一致
 * @author Administrator
 *
 */
public class MainActivity extends Activity implements OnClickListener,LiveStateChangeListener,Callback{
	...
	public void onClick(View v) {
		if (isStart) {
			...
			button01.setText("停止");
			isStart = true;
			livePusher.startPusher("rtmp://120.24.47.95/mytv/100");// TODO: 设置流媒体服务器地址
